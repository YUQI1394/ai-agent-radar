...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    return res.status(200).send(html.replace('<a href="/weekly">Weekly Radar</a>', '<a href="/patterns">Patterns</a><a href="/workspace">Workspace</a><a href="/weekly">Weekly Radar</a>'));
  } catch (error) {
