...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const schema = JSON.stringify({ '@context': 'https://schema.org', '@type': 'CollectionPage', name: `${domain.name} AI Agents`, description: domain.description, url: canonical, numberOfItems: agents.length }).replace(/</g, '\\u003c');
