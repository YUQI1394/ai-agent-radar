...
<body>
  ...
  <main class="page-shell detail-shell">
    ...
    <article class="detail-card">
      ...
      <section class="score-breakdown"><div><span>Adoption</span><strong>${score.adoption ?? score.community}/25</strong></div><div><span>Maintenance</span><strong>${score.maintenance ?? score.freshness}/20</strong></div><div><span>Project quality</span><strong>${score.quality || 0}/20</strong></div><div><span>Agent relevance</span><strong>${score.relevance}/20</strong></div><div><span>Demand evidence</span><strong>${score.demand || 0}/10</strong></div><div><span>Momentum</span><strong>${score.momentum}/5</strong></div><p>Adoption uses stars and forks; maintenance uses code activity; quality checks license and metadata; demand uses high-engagement open Issues; momentum uses star growth.</p></section>
...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    if (!currentAgent && isRetiredLegacySlug(requested)) return sendGone(res);
