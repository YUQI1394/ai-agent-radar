...
<body>
  ...
  <main class="page-shell detail-shell">
    ...
    <article class="detail-card">
      ...
      <section class="score-breakdown"><div><span>Adoption</span><strong>${score.adoption ?? score.community}/40</strong></div><div><span>Maintenance</span><strong>${score.maintenance ?? score.freshness}/25</strong></div><div><span>Agent relevance</span><strong>${score.relevance}/25</strong></div><div><span>Momentum</span><strong>${score.momentum}/10</strong></div><p>Adoption uses GitHub stars and forks; maintenance uses recent code activity; relevance uses repository topics and descriptions; momentum uses star growth between scans.</p></section>
