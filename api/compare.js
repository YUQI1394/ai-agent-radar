...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    return res.status(200).send(html.replace('This site is supported by ads. We do not sell user data.', 'AI Agent Radar · Free, independent open-source intelligence'));
  } catch (error) {
