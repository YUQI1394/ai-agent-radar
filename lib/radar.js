...
const MODEL_PRODUCT = /\b(per 1m tokens|token pricing|model weights|parameters|frontier intelligence|xai api|model api)\b/i;
...
const ADJACENT_PRODUCT = /\b(connect your agent|built for (?:humans and )?ai agents|app builder|build long-running ai agent workflows with|for long-running agents)\b/i;
