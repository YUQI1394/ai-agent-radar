...
const PATTERNS = [
  ...
  { name: 'Tool & system connectors', theme: 'Integrations', pattern: /connector|plugin|webhook|mcp|integrat|api\b|agent mail|mail support/i },
  ...
  { name: 'Runtime & deployment environments', theme: 'Product Capability', pattern: /\bwsl\b|windows users?|dedicated cloud|local ai|locally deployed|runtime-owned|remote ssh|ssh environment/i },
