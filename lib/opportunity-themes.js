...
const INTERNAL_WORK = /^(?:chore|test|ci|build|tracking|intake|publish|plan(?:-\d+)?)\b/i;
...
const VAGUE_REPORT = /^(?:not parsed|no results whatsoever|ctrl\+v (?:doesn'?t|does not) work|import .{0,30} issue)$/i;
...
module.exports = { PATTERNS, THEMES, cleanIssueEvidence, coachingPlan, evidenceEngagement, isUsefulDemandSignal, issueExcerpt, issueFingerprint, opportunityPattern, opportunityTheme };
