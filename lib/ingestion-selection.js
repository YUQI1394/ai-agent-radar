...
function underSourcedCurrentAgents(currentAgents = [], minimumSources = TARGET_CATEGORY_EVIDENCE_PROJECTS) {
  ...
  return currentAgents.filter((agent) => (sourcesByCategory.get(String(agent.category || 'General AI')) || 0) < minimumSources);
}
